...
public class SellVo {
    ...
    private String orderNo;//": "SO2020050002",
    private String orderDate;//": "2020-05-22",
    private Integer sellerId;//": 38737,
    ...
    private Double totalDeliverPrice;//": 0.0,
    private Integer priceUnit;//": 11,
    private String payType;//": "0",
    private String payDeadline;//": "2020-05-29",
    private String leadTime;//": "2020-06-21",
    private Integer type;//": 0,
    private String remark;//": "",
    private Integer status;//": 0,
    private Integer isClosed;//": 1,
    private Integer distributionStatus;//": 0,
    private Integer shippingStatus;//": 0,
    private Integer sellPackageNum;//": 0,
    private Integer distributedPackageNum;//": 0,
    private String distributeablePackageNum;//":

    private List<SellNum> sellNum;
    private List<SellNum> deliverNum;
    private List<SellNum> distributeNum;
