...
!function (A, e) {
	...
	return function (A) {
		...
		e.parseTextDecoration = function (A) {
			var e,
			    t = (e = A.textDecorationLine ? A.textDecorationLine : A.textDecoration, 'none' === e ? null : e.split(' ').map(i));
		...
		var a = function a(A, e) {
			...
			return r(A, [{
				...
				value: function value(A, e) {
					...
					return t.getContext('2d').drawImage(A, 0, 0, A.width, A.height, 0, 0, e.width, e.height), t;
				}
			}, {
				key: 'setOpacity',
				value: function value(A) {
		...
		var c = function c(A, e) {
			...
			var t = e || {},
			    i = new a.default('boolean' != typeof t.logging || t.logging);
		...
		var c = e.LETTER_NUMBER_MODIFIER = 50,
			...
			return [n, a, 'keep-all' === e.wordBreak ? s.map(function (e, t) {
			...
			return n(A, [{
				...
				value: function value(A) {
					...
					for (var a = (0, l.parseCounterReset)(r, this.pseudoContentData), s = (0, l.resolvePseudoContent)(A, n, this.pseudoContentData), i = A.firstChild; i; i = i.nextSibling) {
						(i.nodeType !== Node.ELEMENT_NODE || 'SCRIPT' !== i.nodeName && !i.hasAttribute(Q)) && (this.copyStyles && 'STYLE' === i.nodeName || e.appendChild(this.cloneNode(i)));
