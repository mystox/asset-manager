    ...
    $.ajax({
        type: "get", url: "/api/companys/" + COMPANYID, dataType: "json", beforeSend: function (e) {
            ...
            if (200 == a.code) {
                ...
                if ($.inArray("sampleStore", a.company.modules) === -1) o.addClass("aler-rice-like-content"), o.find("a").attr("href", "javascript:void(0)"), n.addClass("aler-rice-like-content"), n.find("a").attr("href", "javascript:void(0)"), i.addClass("aler-rice-like-content"), i.find("a").attr("href", "javascript:void(0)"); else {
